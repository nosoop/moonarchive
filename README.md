...
While `moonarchive` will still work without specifying proof-of-origin for now, if you plan
on downloading items in parallel it's strongly recommended to [obtain a token][].
